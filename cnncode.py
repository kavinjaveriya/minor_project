...
trainset = traingen.flow_from_directory('/code/dataset/train/' , target_size=(64,64) , batch_size=32 , class_mode='categorical' )
testset = testgen.flow_from_directory('/code/dataset/val/' , target_size=(64,64) , batch_size=32 , class_mode='categorical' )
